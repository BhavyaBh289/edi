...
sample = """ My name is Shirin Shaikh. i was admitted to a hospital. the nurse gave me wrong medicines due to which my health got even worse. i complained about this to the local police officer but the hospital authority bribed the police and my case was dismissed. """
def keywordextract():
    global n , sample

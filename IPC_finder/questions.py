import tkinter
questionlist=[["Was there a serious death threat or grievous hurt threat?", " was the accused falling under the definition of theft , robbery, mischief, or criminal trespass?", " was there an immediate need for personal defence."], ["Was there a serious death threat or grievous hurt threat?","Was the accused of sane mind?","Did the accused intentionally commit the crime?","was there an immediate need for personal defence"]]
accepted_questions = []
x=0
y=0
def yes():
    ...
    print (x,y,len(questionlist[x]),len(questionlist))
...
no_btn = tkinter.Button(root,font=("Times New Roman", 25),text = "No")
